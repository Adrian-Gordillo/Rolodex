...
Nombre completo
Número de teléfono
Dirección de email 3. Gestión Automática del CSV
Creará y gestionará automáticamente el archivo CSV
Asegurará la inclusión de encabezados correctos: Nombre,Telefono,Email
Validará la estructura del archivo antes de cada escritura 4. Bucle continuo
...
Testing: Prueba casos extremos (nombres con comas, emails inválidos, etc.)
Mensajes Claros: Proporciona feedback constante al usuario sobre el estado de las operaciones
Manejo de Excepciones: Captura y gestiona adecuadamente errores de I/O
Código Modular: Aunque no uses POO, organiza tu código en funciones/métodos reutilizables
